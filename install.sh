...
git clone https://github.com/Elkyw/Hyle-X.git
cd Hyle-X
...
read -p "Add 'Hyle-X' to '/usr/bin/' [Y/N]: " confirmation

if [[ $confirmation == 'Y' || $confirmation == 'y' ]] ; then
	sudo cp Hyle-X /usr/bin/
	echo -e "\e[0;32mHyle-X added successfully in /usr/bin, now use Hyle-X as a command... "
else
